      ...
      {showMenu && menuPos && ReactDOM.createPortal(
        <>
          ...
          >
            ...
            <label className="flex w-full items-center gap-2 px-3 py-1.5 text-left text-xs text-[var(--op-sub)] hover:bg-white/[0.04] hover:text-[var(--op-text)] cursor-pointer">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  void updateTask(task.id, { dueDate: newDate });
                  setShowMenu(false);
                }}
                onClick={(e) => {
                  try {
